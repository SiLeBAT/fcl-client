import {Color, DeliveryData, GraphType, ShowType, Size, StationData, Connection, TableMode, FclData, ObservedType} from './../datatypes';
import {List, Map as ImmutableMap} from 'immutable';
import {Utils} from './../utils';
import { combineAll } from 'rxjs/operators';
import {GroupType, Layout} from './../datatypes';
...
export class Constants {
  ...
  static readonly STATION_PROP_INT_TO_EXT_MAP: ImmutableMap<string, ColumnInfo> = ImmutableMap({
    id: {columnId: 'ID', type: 'string'},
    name: {columnId: 'Name', type: 'string'},
    lat: {columnId: 'GeocodingLatitude', type: 'double' },
    lon: {columnId: 'GeocodingLongitude', type: 'double' }/* ,
  ...
  static readonly DELIVERY_PROP_INT_TO_EXT_MAP: ImmutableMap<string, ColumnInfo> = ImmutableMap({
    id: {columnId: 'ID', type: 'string'},
    name: {columnId: 'Name', type: 'string'},
  ...
  static readonly GROUPTYPE_EXT_TO_INT_MAP: ImmutableMap<string, GroupType> = ImmutableMap({
    'SimpleChain' : GroupType.SIMPLE_CHAIN
  });

  static readonly NODE_SIZE_EXT_TO_INT_MAP: ImmutableMap<string, Size> = ImmutableMap({
      '4': Size.SMALL,
      '6': Size.SMALL,
      '10': Size.SMALL,
      '14': Size.MEDIUM,
  ...
  static readonly FONT_SIZE_EXT_TO_INT_MAP: ImmutableMap<string, Size> = ImmutableMap({
    '10': Size.SMALL,
    '12': Size.SMALL,
    '14': Size.MEDIUM,
    '18': Size.MEDIUM,
