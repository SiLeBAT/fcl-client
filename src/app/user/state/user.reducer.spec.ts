...
import { UpdateUserSOA, LoginActivatedSOA } from "./user.actions";
...
describe("user reducer", () => {
    ...
    it("should have valid state after UpdateUserSOA action", () => {
        const currentAction: UpdateUserSOA = new UpdateUserSOA({
    ...
    it("should have valid state after LoginActivatedSOA action", () => {
        ...
        const currentAction: LoginActivatedSOA = new LoginActivatedSOA(
            activationStatus,
        );
