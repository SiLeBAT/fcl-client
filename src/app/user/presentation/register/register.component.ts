...
import { Validators, ValidationErrors, FormControl, FormGroup, ValidatorFn } from '@angular/forms';
...
export class RegisterComponent {
    ...
    private passwordConfirmationValidator(fg: FormGroup<RegisterForm>): ValidationErrors | null {
