...
const DEL_COLREF_2_TYPESTRING = {
    lat: 'lat',
    lon: 'lon'
} as const satisfies Readonly<Partial<Record<ColumnRef<'deliveries'>, TypeString>>>;


export const DELIVERY_IDENT_FIELDS = [
    'source',
    'productName',
    'lotNo',
    'dateOut', 'dateIn', 'unitAmount',
    'target'
] as const satisfies Readonly<(keyof DeliveryRow)[]>;

export const STATION_IDENT_FIELDS = [
    'name', 'address', 'country'
] as const satisfies Readonly<(keyof StationRow)[]>;
