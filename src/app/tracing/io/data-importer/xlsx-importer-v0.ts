...
import { Workbook as IntWorkbook, Worksheet as IntWorksheet, Row as WSRow, HeaderConf, ColumnHeader, ReadTableOptions, Table, CheckColumnHeaderOptions, Row, TableHeader, CellSpecs, TypeString, EachRowOptions} from './xlsx-model';
...
export class XlsxImporter {
    ...
    eachRow(sheetName: string, cb: (rowIndex: number, ), options: ReadTableOptions): void {
        // const tableRows: Row[] = [];
        const
