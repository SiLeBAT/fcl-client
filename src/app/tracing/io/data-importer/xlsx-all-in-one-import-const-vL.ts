...
const MANDATORY_DEL_COLS = [
    'extId', 'source', 'productName',
    'lotNo', 'lotAmount_number', 'lotAmount_unit',
    'dateOut_day', 'dateOut_month', 'dateOut_year',
    'dateIn_day', 'dateIn_month', 'dateIn_year',
    'unitAmount_quantity', 'unitAmount_unit', 'target'
] as const satisfies Readonly<ColumnRef<'deliveries'>[]>;

export const MANDATORY_COL_REFS = {
    [DEL_SHEET_REF]: MANDATORY_DEL_COLS
} as const
