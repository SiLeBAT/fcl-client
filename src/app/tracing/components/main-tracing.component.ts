...
export class MainTracingComponent implements OnInit, OnDestroy {
    ...
    // @ContentChild(SchemaGraphComponent, /* TODO: add static flag */ {}) schemaGraphContentChild: SchemaGraphComponent;
    // @ContentChild(GisGraphComponent, /* TODO: add static flag */ {}) gisGraphContentChild: GisGraphComponent;
