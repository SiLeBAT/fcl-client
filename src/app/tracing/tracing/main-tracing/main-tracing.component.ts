...
export class MainTracingComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.subscriptions.push(this.mainPageService.doSaveImage.subscribe(() => this.onSaveImage()));
        this.subscriptions.push(this.mainPageService.doVisioLayout.subscribe(() => this.onVisioLayout()));
        this.subscriptions.push(this.mainPageService.doOnLoad.subscribe(event => this.onLoad(event)));
        this.subscriptions.push(this.mainPageService.doOnSave.subscribe(() => this.onSave()));
