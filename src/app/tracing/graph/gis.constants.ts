...
const EMPTY_FRAME_TOPLEFT_POS = UIUtils.latLonToPosition(EMPTY_FRAME_MAX_LAT, EMPTY_FRAME_MIN_LON, REF_ZOOM);
const EMPTY_FRAME_BOTTOMRIGHT_POS = UIUtils.latLonToPosition(EMPTY_FRAME_MIN_LAT, EMPTY_FRAME_MAX_LON, REF_ZOOM);
