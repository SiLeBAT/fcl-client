...
export class ContextMenuService {
  ...
  private createStationActions(
    ...
    return concat(
      layoutOptions !== null
        ? this.createLayoutMenuData(layoutOptions, contextElements.nodeIds)
        : [],
      [
        {
      ...
      children: [
        {
          ...
          action:
            getAction === null ? undefined : getAction(ObservedType.FORWARD),
        },
        {
          ...MenuItemStrings.backwardTrace,
          action:
            getAction === null ? undefined : getAction(ObservedType.BACKWARD),
        },
        {
