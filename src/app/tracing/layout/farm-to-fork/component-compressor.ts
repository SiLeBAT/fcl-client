    ...
    for (const layer of graph.layers) {
        for (const vertex of layer.filter(
            ...
            if (
                ...
                let y: number =
                    vertexGroup.y -
                    (vertexGroup.innerSize / 2) * vertexGroup.innerScale;
    ...
    for (const layer of graph.layers) {
        for (const vertex of layer.filter(
            ...
            if (
                ...
                let y =
                    vertex.y - (vertex.innerSize / 2) * vertexGroup.innerScale;
