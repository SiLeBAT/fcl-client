...
export class HighlightingStationViewComponent {
    ...
    showHighlightingDialog: boolean = false;
    addButtonDisabled: boolean = false;
    labelsOpenState = false;
    stationSizeOpenState = false;
    coloursAndShapesOpenState = false;

    private processedInput_: HighlightingInputData = null;
    private colorAndShapeHighlightings_: StationHighlightingData[] = null;
    private highlightingStationConditionViewInputData_: HighlightingConditionInputData = null;
