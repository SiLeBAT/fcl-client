...
export class HighlightingStationConditionViewComponent {
    ...
    availableShapeTypes: (NodeShapeType | string)[] = [
        Constants.NOSHAPE_TYPE,
    ...
    private processedInput_: HighlightingConditionInputData = null;
    private complexFilterConditions_: LogicalFilterCondition[] = null;
    private dataColumns_: TableColumn[] = null;
    private propToValuesMap_: PropValueMap = null;
    ...
    onShapeChange(shapeType: (NodeShapeType | string)): void {
        this.stationHighlightingCondition_ = {
            ...this.stationHighlightingCondition_,
