...
import { ComplexRowFilterSettings, HighlightingConditionToDelete } from '../configuration.model';
...
export class HighlightingStationComponent implements OnInit, OnDestroy {
    ...
    onHighlightingConditionsDelete(conditionToDelete: HighlightingConditionToDelete) {
        this.store.dispatch(new configurationActions.DeleteStationHighlightingRulesSOA(
