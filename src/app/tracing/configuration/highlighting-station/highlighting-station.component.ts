...
export class HighlightingStationComponent implements OnInit, OnDestroy {
    ...
    private cachedState: HighlightingTableState;
    private highlightingStationViewInputData_: HighlightingInputData;
    ...
    onHighlightingConditionChange(newHighlightingRule: StationHighlightingData[]) {
        this.store.dispatch(new tracingActions.AddColoursAndShapesHighlightingRuleSOA(
            { stationHighlightingData: newHighlightingRule }
        ));
    }
