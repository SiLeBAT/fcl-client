...
const contentRoutes: Routes = [{
    ...
    children: [
        { path: contentPathsSegments.faq, component: FaqComponent, resolve: { faqCollection: FaqResolverService } },
        { path: contentPathsSegments.dataProtectionDeclaration, component: DataProtectionDeclarationComponent },
        { path: contentPathsSegments.dataProtectionNotice, component: DataProtectionNoticeComponent }
    ]
}];
