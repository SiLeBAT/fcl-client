...
/**
 * Adds the ROA style palette to the sidebar.
 */
Sidebar.prototype.addRoaStylePalette = function(expand)
{
	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

    var fns = [
        this.createVertexTemplateEntry(
            'rounded=1;whiteSpace=wrap;html=1;fillColor=lightgrey;strokeColor=none;arcSize=1;verticalAlign=top;align=left;spacingTop=10;spacingLeft=10;',
            500, 300, 'Country', 'Group', null, null, 'rounded rect rectangle box group country'),

        this.createVertexTemplateEntry(
            'rounded=1;whiteSpace=wrap;html=1;fillColor=white;strokeColor=none;arcSize=5;verticalAlign=top;align=center;spacingTop=5',
            150, 100, 'Station', 'Station', null, null, 'rounded rect rectangle box station'),

        this.createVertexTemplateEntry(
            'rounded=1;whiteSpace=wrap;html=1;fillColor=#bbdefb;strokeColor=none;arcSize=8;verticalAlign=top;align=center;spacingTop=5',
        ...
        this.createVertexTemplateEntry(
            'rounded=1;whiteSpace=wrap;html=1;fillColor=#b3ffb3;strokeColor=none;arcSize=10;verticalAlign=top;align=center;spacingTop=2',
	...
	this.addPaletteFunctions('roa', mxResources.get('roa'), (expand != null) ? expand : true, fns);
};
