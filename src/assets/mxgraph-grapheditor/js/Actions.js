...
Actions.prototype.init = function()
{
    ...
    // this.addAction('export...', function() { ui.showDialog(new ExportDialog(ui).container, 400, 230, true, true); });
	...
	this.put('about', new Action(mxResources.get('about') + ' FCL-Graph Editor...', function()
	{
		if (!showingAbout)
		{
